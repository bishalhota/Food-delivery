...
const AddRestaurant = () => {
    ...
    return (
        <div className='min-h-screen bg-gray-50 px-4 py-6'>
            <div className='mx-auto max-w-lg shadow-sm rounded-xl bg-white p-6 space-y-5'>
                ...
                <div className='flex items-start gap-3 rounded-lg border p-4'>
                    ...
                    <div className="text-sm">
                        {
                            loadingLocation ? "Fetching Location..." : location?.formattedAddress || "Location not found"
                        }
                    </div>
                </div>
